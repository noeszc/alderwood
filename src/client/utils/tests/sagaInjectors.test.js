...
describe('injectors', () => {
  ...
  describe('getInjectors', () => {
    beforeEach(() => {
      store = get(configureStore({}, memoryHistory), 'store');
    });
  ...
  describe('ejectSaga helper', () => {
    ...
    it('should remove non DAEMON sagas descriptor in production', () => {
    ...
    it('should not remove sagas descriptor in production', () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should not remove DAEMON sagas descriptor in development', () => {
      injectSaga('test', { saga: testSaga, mode: DAEMON });
      ejectSaga('test');
  ...
  describe('injectSaga helper', () => {
    ...
    it('should validate sagas descriptor', () => {
